...
bot.on('message', function(event) {
	...
	request.on('response', function(response) {
  	...
  	if (action == '電影時刻表') {
  		var collection = myDB.collection('data'); //使用myDB的方法collection('data')取得data這個collection
		  collection.find({'user : Jason'}).toArray(function(err, docs){ //使用collection的方法find()取得資料表內的內容，{}表示取得全部內容
		    if(err){                                     //使用toArray()將資料轉成陣列，function的docs是轉成陣列後的結果
		      response.status(406).end();              //轉陣列過程若有err，回傳給錯誤碼406，此為Http協定狀態碼      
		    } else{                                      //.end()為將資料回傳給使用者
		      //response.type('application/json');       //沒有錯誤回傳狀態碼200並附帶著資料，因為MongoDB存的資料就是JSON，所以不用特別轉換
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城正義聯盟'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城別闖陰陽界'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城氣象戰'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城奪魂鋸：遊戲重啟'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城乒乓少女大逆襲'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城追兇'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城神力女超人的秘密'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城解憂雜貨店'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城絕處逢山'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
  ...
  }else if (action == '林口MITSUIOUTLETPARK威秀影城雷神索爾3諸神黃昏'){
    event.reply('您所查詢的電影時刻如下:'+'\n'+aiSpeech).then(function(data) {
      // 傳送訊息成功時，可在此寫程式碼 
      console.log(aiSpeech);
    }).catch(function(error) {
